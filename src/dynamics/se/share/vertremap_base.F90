...
!=======================================================================================================!
  ...
  real (kind=r8), dimension(nlev)      :: h,Qcol,dy,za0,za1,za2,zarg,zhdp,dp_star,dp_np1
  real (kind=r8)  :: f_xm,level1,level2,level3,level4,level5, &
...
subroutine remap_Q_ppm(Qdp,nx,qsize,dp1,dp2)
  ...
  real(kind=r8) :: mymass, massn1, massn2
...
function compute_ppm( a , dx )    result(coefs)
  ...
  real(kind=r8) :: dx1, dx2, dx3, dx4, dx5, dx6, dx7, dx8, dx9, dx10
